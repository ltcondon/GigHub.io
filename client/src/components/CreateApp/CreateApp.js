      ...
      return (
        <div>
          ...
          >
            ...
            <DialogContent>
              <DialogContentText>Congrats <span className="userName">{this.state.firstName} {this.state.lastName}!</span> Way to take initiative! The first step can often be the hardest, but we're here to help. Provide some details below.</DialogContentText>
              <TextField
                autoFocus
                margin="dense"
                id="company"
